...
public class ScalableImageViewReference extends View {
    ...
    public ScalableImageViewReference(Context context) {
        super(context);
        init(context);
    }

    public ScalableImageViewReference(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
